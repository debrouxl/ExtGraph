...
DrawTiles16W89:
    ...
    moveq.l  #10-1,%d3
PutPlane_DrawTiles16W89:
    moveq.l  #6-1,%d1
PutCol_DrawTiles16W89:
    move.w   (%a0),%d0		| d0 = num_sprt
    lsl.w    #5,%d0		| d0 *= 16*2
    lea.l    0(%a2,%d0.w),%a3	| a3 = sprt

    moveq.l  #4-1,%d0
PutTile_DrawTiles16W89:
    move.w   (%a3)+,(%a1)
    move.w   (%a3)+,30*1(%a1)
    move.w   (%a3)+,30*2(%a1)
    move.w   (%a3)+,30*3(%a1)
    ...
    dbf      %d0,PutTile_DrawTiles16W89

    adda.w   %d2,%a0
    dbf      %d1,PutCol_DrawTiles16W89
    ...
    dbf      %d3,PutPlane_DrawTiles16W89
