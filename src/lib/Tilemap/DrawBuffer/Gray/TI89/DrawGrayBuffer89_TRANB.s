...
DrawGrayBuffer89_TRANB:
    ...
    moveq.l  #16,%d1
    cmp.w    %d1,%d0	| d0 < 16 ?
    blt.s    OK_DrawGrayBuffer89_TRANB
    addq.l   #2,%a0
    sub.w    %d1,%d0
OK_DrawGrayBuffer89_TRANB:
...
LineStart_DrawGrayBuffer89_TRANB:
    swap.w   %d2
    ...
    swap.w   %d2
    dbf      %d2,LineStart_DrawGrayBuffer89_TRANB
