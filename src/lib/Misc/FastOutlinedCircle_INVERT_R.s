| C prototype: void FastOutlinedCircle_INVERT_R(void *plane asm("%a0"),unsigned short xcenter asm("%d0"),unsigned short ycenter asm("%d1"),unsigned short radius asm("%d2"));
|
...
.text
.globl FastOutlinedCircle_INVERT_R
.even

FastOutlinedCircle_INVERT_R:
