| C prototype: void GrayClipFastOutlinedCircle_LGRAY_R(void *planes asm("%a0"),unsigned short xcenter asm("%d0"),unsigned short ycenter asm("%d1"),unsigned short radius asm("%d2"));
|
...
.text
.globl GrayClipFastOutlinedCircle_LGRAY_R
.even

GrayClipFastOutlinedCircle_LGRAY_R:
