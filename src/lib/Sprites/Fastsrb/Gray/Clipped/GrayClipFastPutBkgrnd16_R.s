| C prototype: void GrayClipFastPutBkgrnd16_R(short x asm("%d0"),short y asm("%d1"),short h asm("%d2"),unsigned long *sprt,void *dest1 asm("%a0"),void *dest2 asm("%a1")) __attribute__((__stkparm__));
|
