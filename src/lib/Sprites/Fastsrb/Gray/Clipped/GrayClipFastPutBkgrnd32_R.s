| C prototype: void GrayClipFastPutBkgrnd32_R(short x asm("%d0"),short y asm("%d1"),short h asm("%d2"),unsigned short *sprt,void *dest1 asm("%a0"),void *dest2 asm("%a1")) __attribute__((__stkparm__));
|
