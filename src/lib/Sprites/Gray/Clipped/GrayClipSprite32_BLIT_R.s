| C prototype: void GrayClipSprite32_BLIT_R(short x asm("%d0"),short y asm("%d1"),short h asm("%d2"),unsigned long *sprt0,unsigned long *sprt1,unsigned long maskval asm("%d3"),void *dest0 asm("%a0"),void *dest1 asm("%a1")) __attribute__((__stkparm__));
