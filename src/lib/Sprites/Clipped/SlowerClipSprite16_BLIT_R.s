...
__YPositive_ClipSprite16_BLIT_R:
    ...
    bhi.s    __End_ClipSprite16_BLIT_R		| y - (PLANE_PIXEL_HEIGHT-1) > 0 ?
    add.w    %d2,%d3		| %d3 = h + y - (PLANE_PIXEL_HEIGHT-1)
    bmi.s    __CalcOffset_ClipSprite16_BLIT_R	| h + y - (PLANE_PIXEL_HEIGHT-1) < 0 ?
...
__ClipX_ClipSprite16_BLIT_R:
    ...
    bhi.s    __ClipXRight_ClipSprite16_BLIT_R	| x > PLANE_PIXEL_WIDTH-1-15
...
__ClipXRight_ClipSprite16_BLIT_R:
    ...
    bhi.s    __End_ClipSprite16_BLIT_R		| x > PLANE_PIXEL_WIDTH-1
