| C prototype: void ClipSprite32_MASK_R(short x asm("%d0"),short y asm("%d1"),short h asm("%d2"),unsigned long *sprt asm("%a1"),unsigned long *mask,void *dest asm("%a0")) __attribute__((__stkparm__));
