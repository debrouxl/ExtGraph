...
RefreshAnimatedBuffer16B:
    movem.l  %d3/%a4,-(%a7)

    moveq.l  #16,%d3
PutPlane_RefreshAnimatedBuffer16B:
    moveq.l  #9,%d1
PutCol_RefreshAnimatedBuffer16B:
    clr.w    %d0
    ...
    moveq.l  #3,%d0
PutTile_RefreshAnimatedBuffer16B:
    move.w   (%a4)+,(%a1)
    move.w   (%a4)+,34*1(%a1)
    move.w   (%a4)+,34*2(%a1)
    move.w   (%a4)+,34*3(%a1)
    ...
    dbf      %d0,PutTile_RefreshAnimatedBuffer16B

    adda.w   %d2,%a0
    dbf      %d1,PutCol_RefreshAnimatedBuffer16B
    ...
    dbf      %d3,PutPlane_RefreshAnimatedBuffer16B
