...
DrawGrayTiles8B:
    ...
    moveq.l  #30-1,%d3
PutPlane_DrawGrayTiles8B:
    moveq.l  #16-1,%d1
PutCol_DrawGrayTiles8B:
    clr.w    %d0
...
PutTile_DrawGrayTiles8B:
    ...
    dbf      %d0,PutTile_DrawGrayTiles8B

    adda.w   %d2,%a0
    dbf      %d1,PutCol_DrawGrayTiles8B

    lea.l    -3840+1(%a1),%a1	| next column
    move.w   %d2,%d1
    lsl.w    #4,%d1
    subq.w   #1,%d1		| d1 = larg_map*16 - 1
    suba.l   %d1,%a0

    dbf      %d3,PutPlane_DrawGrayTiles8B
