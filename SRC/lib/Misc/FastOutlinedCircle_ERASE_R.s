| C prototype: void FastOutlinedCircle_ERASE_R(void *plane asm("%a0"),unsigned short xcenter asm("%d0"),unsigned short ycenter asm("%d1"),unsigned short radius asm("%d2"));
|
...
.text
.globl FastOutlinedCircle_ERASE_R
.even

FastOutlinedCircle_ERASE_R:
