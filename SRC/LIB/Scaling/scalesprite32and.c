...
void ScaleSprite32_AND(const unsigned long *sprite,void *dest,short x0,short y0,short sizex,short sizey) {
    short x;//,y;
    unsigned short u,v=0,du=(unsigned short)(32<<8)/(unsigned short)sizex,dv=(unsigned short)(32<<8)/(unsigned short)sizey,tempv,pix32,pixscreen;
    unsigned char *src;
