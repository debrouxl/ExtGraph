| C prototype: void GrayDrawSpan_BLACK_R(unsigned short x1 asm("%d0"), unsigned short x2 asm("%d1"), unsigned char * addrs asm("%a0"));
|
| This routine draws lines from x1 to x2 in line starting at addr, in
| black color. It is primarily intended as callback for Gray(Clip)FilledTriangle_R.
|--------------------------------** WARNING **--------------------------------
