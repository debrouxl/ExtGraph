| C prototype: void GrayClipSprite8_MASK_R(short x asm("%d0"),short y asm("%d1"),short h asm("%d2"),unsigned char *sprt0,unsigned char *sprt1,unsigned char *mask0,unsigned char *mask1,void *dest0 asm("%a0"),void *dest1 asm("%a1")) __attribute__((__stkparm__));
