| C prototype: void GrayClipISpriteX16_OR_R(register short x asm("%d0"), register short y asm("%d1"),register short h asm("%d3"),unsigned short *sprt,register short w asm("%d2"),register void *dest0 asm("%a0"),register void *dest1 asm("%a1")) __attribute__((__stkparm__));
|
| Based on GrayClipISpriteX16_MASK_R.
