| C prototype: void ClipSprite16_AND_R(register short x asm("%d0"),register short y asm("%d1"),register short h asm("%d2"),register unsigned short *sprt asm("%a1"),register void *dest asm("%a0"));
...
__YPositive_ClipSprite16_AND_R:
    ...
    bhi.s    __End_ClipSprite16_AND_R		| y - 128 > 0 ?
    add.w    %d2,%d3		| %d3 = h + y - 128
    bmi.s    __CalcOffset_ClipSprite16_AND_R	| h + y - 128 < 0 ?
...
__ClipX_ClipSprite16_AND_R:
    ...
    cmpi.w   #239-16,%d0
    bhi.s    __ClipXRight_ClipSprite16_AND_R	| x > 239-15
    lsr.w    #4,%d3		| %d3 = x/16
...
__ClipXRight_ClipSprite16_AND_R:
    cmpi.w   #239,%d0
    bhi.s    __End_ClipSprite16_AND_R		| x > 239
