| C prototype: void ClipSprite32_BLIT_R(short x asm("%d0"),short y asm("%d1"),short h asm("%d2"),unsigned long *sprt asm("%a1"),unsigned long maskval asm("%d3"),void *dest asm("%a0"));
