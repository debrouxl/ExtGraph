| C prototype: void GrayFastGetBkgrnd16_R(register short x asm("%d0"),register short y asm("%d1"),register short h asm("%d2"),register void* src1 asm("%a0"),register void* src2 asm("%a1"),register unsigned short* dest asm("%a2"));
|
