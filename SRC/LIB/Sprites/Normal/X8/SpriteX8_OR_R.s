| C prototype: void SpriteX8_OR_R(short x asm("%d0"), short y asm("%d1"),short h asm("%d2"),short w asm("%d3"),unsigned char *sprt asm("%a1"),void *dest asm("%a0")) __attribute__((__regparm__));
