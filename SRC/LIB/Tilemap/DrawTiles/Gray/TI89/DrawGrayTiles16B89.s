...
DrawGrayTiles16B89:
    ...
    moveq.l  #10-1,%d3
PutPlane_DrawGrayTiles16B89:
    moveq.l  #6-1,%d1
PutCol_DrawGrayTiles16B89:
    clr.w    %d0
...
PutTile_DrawGrayTiles16B89:
    ...
    dbf      %d0,PutTile_DrawGrayTiles16B89

    adda.w   %d2,%a0
    dbf      %d1,PutCol_DrawGrayTiles16B89
    ...
    add.w    %d2,%d1
    add.w    %d1,%d1
    subq.w   #1,%d1		| d1 = larg_map*6 - 1
    suba.l   %d1,%a0		| map -= larg_map*6 - 1

    dbf      %d3,PutPlane_DrawGrayTiles16B89
