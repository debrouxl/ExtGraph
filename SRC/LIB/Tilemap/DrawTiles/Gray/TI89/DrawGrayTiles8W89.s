...
DrawGrayTiles8W89:
    ...
    moveq.l  #20-1,%d3
PutPlane_DrawGrayTiles8W89:
    moveq.l  #12-1,%d1
PutCol_DrawGrayTiles8W89:
    move.w   (%a0),%d0		| d0 = num_sprt
    lsl.w    #4,%d0		| d0 *= 8*2
    lea.l    0(%a2,%d0.w),%a3	| a3 = sprt

    moveq.l  #1,%d0
PutTile_DrawGrayTiles8W89:
    move.b   (%a3)+,(%a1)
    move.b   (%a3)+,3840(%a1)
    ...
    dbf      %d0,PutTile_DrawGrayTiles8W89

    adda.w   %d2,%a0
    dbf      %d1,PutCol_DrawGrayTiles8W89
    ...
    dbf      %d3,PutPlane_DrawGrayTiles8W89
