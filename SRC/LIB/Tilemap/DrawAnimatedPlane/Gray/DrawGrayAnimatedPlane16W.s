...
| check if tiles need to be animated
    ...
    sub.w    (%a3),%d2
    bne.s    No_anim_DrawGrayAnimatedPlane16W
    ...
    sub.w    (%a3),%d2
    bne.s    RefreshGrayAnimatedBuffer_DrawGrayAnimatedPlane16W

    move.w   %d2,(%a3) | clear step counter
    bra.s    RefreshGrayAnimatedBuffer_DrawGrayAnimatedPlane16W

No_anim_DrawGrayAnimatedPlane16W:
...
| check if refreshing big_vscreen is needed
    ...
    bpl.s    dx_pos_DrawGrayAnimatedPlane16W
    neg.w    %d2
dx_pos_DrawGrayAnimatedPlane16W:
    moveq.l  #32,%d4
    cmp.w    %d4,%d2 | old x - new x >= 32
    bge.s    RefreshGrayAnimatedBuffer_DrawGrayAnimatedPlane16W
    ...
    bpl.s    dy_pos_DrawGrayAnimatedPlane16W
    neg.w    %d2
dy_pos_DrawGrayAnimatedPlane16W:
    ...
    eor.w    %d2,%d3
    beq.s    DrawBuffer_DrawGrayAnimatedPlane16W

RefreshGrayAnimatedBuffer_DrawGrayAnimatedPlane16W:
    ...
    bsr      RefreshGrayAnimatedBuffer16W
...
DrawBuffer_DrawGrayAnimatedPlane16W:
