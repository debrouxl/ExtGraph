...
| check if tiles need to be animated
    ...
    sub.w    (%a3),%d2
    bne.s    No_anim_DrawGrayAnimatedPlane16B
    ...
    sub.w    (%a3),%d2
    bne.s    RefreshAnimatedBuffer_DrawGrayAnimatedPlane16B
    move.w   %d2,(%a3) | clear step counter
    bra.s    RefreshAnimatedBuffer_DrawGrayAnimatedPlane16B

No_anim_DrawGrayAnimatedPlane16B:
...
| check if refreshing big_vscreen is needed
    ...
    bpl.s    dx_pos_DrawGrayAnimatedPlane16B
    neg.w    %d2
dx_pos_DrawGrayAnimatedPlane16B:
    moveq.l  #32,%d4
    cmp.w    %d4,%d2 | old x - new x >= 32
    bge.s    RefreshAnimatedBuffer_DrawGrayAnimatedPlane16B
    ...
    bpl.s    dy_pos_DrawGrayAnimatedPlane16B
    neg.w    %d2
dy_pos_DrawGrayAnimatedPlane16B:
    ...
    eor.w    %d2,%d3
    beq.s    DrawBuffer_DrawGrayAnimatedPlane16B

RefreshAnimatedBuffer_DrawGrayAnimatedPlane16B:
    ...
    bsr      RefreshGrayAnimatedBuffer16B
...
DrawBuffer_DrawGrayAnimatedPlane16B:
