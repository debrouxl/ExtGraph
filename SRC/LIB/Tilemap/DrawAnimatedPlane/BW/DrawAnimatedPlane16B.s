...
| check if tiles need to be animated
    ...
    sub.w    (%a3),%d2
    bne.s    No_anim_DrawAnimatedPlane16B
    ...
    sub.w    (%a3),%d2
    bne.s    RefreshAnimatedBuffer_DrawAnimatedPlane16B
    move.w   %d2,(%a3) | clear step counter
    bra.s    RefreshAnimatedBuffer_DrawAnimatedPlane16B

No_anim_DrawAnimatedPlane16B:
...
| check if refreshing big_vscreen is needed
    ...
    bpl.s    dx_pos_DrawAnimatedPlane16B
    neg.w    %d2
dx_pos_DrawAnimatedPlane16B:
    moveq.l  #32,%d4
    cmp.w    %d4,%d2 | old x - new x >= 32
    bge.s    RefreshAnimatedBuffer_DrawAnimatedPlane16B
    ...
    bpl.s    dy_pos_DrawAnimatedPlane16B
    neg.w    %d2
dy_pos_DrawAnimatedPlane16B:
    ...
    eor.w    %d2,%d3
    beq.s    DrawBuffer_DrawAnimatedPlane16B

RefreshAnimatedBuffer_DrawAnimatedPlane16B:
...
DrawBuffer_DrawAnimatedPlane16B:
