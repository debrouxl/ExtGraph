	.text
	xdef DrawGrayBufferWithShifts_TRANW
...
DrawGrayBufferWithShifts_TRANW:
...
LineStart_DrawGrayBufferWithShifts_TRANW:
    swap.w   %d2
    ...
    add.b    (%a2),%d0
    cmp.w    %d1,%d0	| d0 < 16 ?
    blt.s    OK_DrawGrayBufferWithShifts_TRANW
    addq.l   #2,%a0
    addq.l   #2,%a4
    sub.w    %d1,%d0
OK_DrawGrayBufferWithShifts_TRANW:
    ...
    cmpi.w   #16,%d0	| d0 < 16 ?
    bge.s    OK2_DrawGrayBufferWithShifts_TRANW
    addq.l   #2,%a0
    addq.l   #2,%a4
OK2_DrawGrayBufferWithShifts_TRANW:

    adda.w   (%a3),%a0 | Décalage vertical
    adda.w   (%a3)+,%a4

    swap.w   %d2
    dbf      %d2,LineStart_DrawGrayBufferWithShifts_TRANW
