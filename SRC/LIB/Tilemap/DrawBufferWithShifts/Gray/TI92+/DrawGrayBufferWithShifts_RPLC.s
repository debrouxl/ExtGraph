	.text
	xdef DrawGrayBufferWithShifts_RPLC
...
LineStart_DrawGrayBufferWithShifts_RPLC:

    moveq.l  #16,%d1
    move.w   %a6,%d0	| décalage initial
    add.b    (%a2),%d0	| Décalage horizontal
    cmp.w    %d1,%d0	| d0 < 16 ?
    blt.s    OK_DrawGrayBufferWithShifts_RPLC
    addq.l   #2,%a0
    addq.l   #2,%a4
    sub.w    %d1,%d0
OK_DrawGrayBufferWithShifts_RPLC:
    ...
    add.b    (%a2)+,%d0	| Décalage horizontal
    cmpi.w   #16,%d0	| d0 < 16 ?
    bge.s    OK2_DrawGrayBufferWithShifts_RPLC
    addq.l   #2,%a0
    addq.l   #2,%a4
OK2_DrawGrayBufferWithShifts_RPLC:

    adda.w   (%a3),%a0 | Décalage vertical
    adda.w   (%a3)+,%a4

    dbf      %d7,LineStart_DrawGrayBufferWithShifts_RPLC
